...
- 예산: 교내연수 강사비 단가 예시(2시간=강의료16만+원고료10만, 3시간=21만+15만). 리더십 워크숍은 렌트비·대관료(300만 이하)·체험비·식비 가능, 숙소비·여비·유류비 불가. 패들렛·카훗·북크리에이터 등은 학교 공용 계정 구독. 생성형AI 구독료 개산급 지출 사례(행정실 사전 협의 필수). 학생 캠프는 간식·재료·도서·강사비 사례. 외부 강사는 학운위 불필요, 교내(내부) 강사는 학운위 심의 필수.
