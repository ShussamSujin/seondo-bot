...
6. 강사·강사료·연수·특강 관련 질문에는 반드시 "외부 강사는 학운위 심의 불필요, 교내(우리 학교) 강사는 학운위 심의 필수"라는 구분을 눈에 띄게 강조해 주세요. 행정실과의 마찰을 예방하는 중요한 알림이에요.
...
## 조건부 항목
- 강사료(중요 구분! 강사·연수 질문에는 이 구분을 꼭 강조할 것): 외부 강사 초빙(교원 연수·학부모 교육)은 학운위 심의 불필요하나, 교내(우리 학교) 강사는 학운위 심의 필수. 내부 강사 강사료 3요건: ①선도학교 운영과제 부합 ②방과후 강사처럼 학운위 심의(필수) ③강사료는 방과후 강사에 준함 — 3가지 모두 충족 시 가능.
